...
export function ChatMessage({ message }: { message: Message }) {
  ...
  return (
    <div
      className={`flex w-full mb-3 items-end ${isUser ? "justify-end animate-message-in-right" : "justify-start animate-message-in-left"
        }`}
    >
      {!isUser && (
        <div
      ...
      <div
        className={`max-w-[78%] rounded-2xl px-4 py-2.5 text-[13.5px] leading-relaxed ${isUser ? "rounded-br-md" : "rounded-bl-md"
          }`}
        style={
          isUser
            ? {
